...
const clickMenuToggle = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (menu && menuIcon && closeIcon) {
        ...
        if (menuIcon.contains(e.target as Node) || closeIcon.contains(e.target as Node)) {
                    ...
                    <Link title="LeoDG" to="/" className="flex items-center space-x-3 rtl:space-x-reverse mt-2 ml-6 text-black hover:fill-blue-600 hover:text-blue-600">
                            ...
                            >
                                <svg
                                    ...
                                    height="115.11161041259766"
                                    preserveAspectRatio="xMidYMid meet"
                                    viewBox="0 0 300.0000305175781 115.11161041259766"
                                    overflow="visible"
                                    className="mx-4 my-1 h-10 w-40"
                                    aria-label="LeoDG"
                                >
                                    <defs id="SvgjsDefs15752" />
                                    <g
                                        id="SvgjsG15753"
                                        transform="scale(0.6493506493506492)"
                                        opacity="1"
                                    >
                                        <g
                                            id="SvgjsG15754"
